...
IconData getCameraLensIcon(CameraLensDirection direction) {
  ...
  throw ArgumentError('Unknow lens direction');
}

void logError(String code, String message) => print('Error: $code\nError Message: $message');

class CameraExampleRoute extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CameraExampleRouteState();
}

class _CameraExampleRouteState extends State<CameraExampleRoute>
  ...
  Widget _cameraPreviewWidget() {
    if (controller == null || !controller.value.isInitialized) {
      return const Text('选择一个摄像头', style: TextStyle(
 ...
 Widget _thumbnailWidget() {
    return Align(
      ...
      child: Row(
        ...
        children: <Widget>[
          videoController == null && imagePath == null ? Container() : SizedBox(
 ...
 /// 相机工具栏
 Widget _captureControllRowWidget() {
    return Row(
      ...
      children: <Widget>[
        ...
        IconButton(
          ...
          color: Colors.red,
          onPressed: controller != null && controller.value.isInitialized && controller.value.isInitialized && controller.value.isRecordingVideo ? onStopButtonPressed : null,
        )
      ],
    );
 }
